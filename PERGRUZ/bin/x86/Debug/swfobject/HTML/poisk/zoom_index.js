dictwords = ["chapter 0 27 5 27",
	"top 0 15 1 15 2 15 3 15 4 15 5 15 6 15",
	"previous 0 15 2 15 3 15 4 15 5 15 6 15",
	"next 0 15 1 15 3 15 4 15 5 15 6 15",
	"введите 0 15 1 15 2 15 3 15 4 15 5 15 6 15",
	"здесь 0 15 1 15 2 15 3 15 4 15 5 15 6 15",
	"текст 0 15 1 15 2 15 3 15 4 15 5 15 6 15",
	"раздела 0 15 1 15 2 15 3 15 4 15 5 15 6 15",
	"chapter_2.htm 0 10",
	"introduction 1 27",
	"introduction.htm 1 10",
	"new 2 27",
	"topic 2 27 4 27 6 27",
	"new_topic.htm 2 10",
	"overview 3 27",
	"overview.htm 3 10",
	"second 4 27",
	"second_topic.htm 4 10",
	"sub 5 27",
	"2.1 5 27",
	"sub_chapter_2_1.htm 5 10",
	"welcome 6 27",
	"welcome_topic.htm 6 10"];
